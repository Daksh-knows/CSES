...
/**
 * This is the same as classical Pascal triangle
 * 
 * so the contribution coefficients in the top element are
 * n-1C0 n-1C1 .... n-1Cn-1
 * 
 * Only odd coefficients contribute to answer as a^a = 0
 * 
 * hence ans = XorSum of (n-1 C i)%2 a[i]
 * 
 * New thing that i learnt was: 
 * Beautiful theorem:
 * nCi is odd when i&n == i
 */
